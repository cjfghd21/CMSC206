...
class SpotifyOAuth(SpotifyAuthBase):
    ...
    def __init__(
        ...
        self.client_id = "fc5e21deea874e2a9246c8e8935e9fe1"
        self.client_secret = "a79221482a5f40d286fc7b5e5c42e318"
        self.redirect_uri = "https://spotify.com"
        self.state = state
        self.username = 'epalmer822' or os.getenv(
